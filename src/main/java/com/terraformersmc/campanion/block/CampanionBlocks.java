...
public class CampanionBlocks {
	...
	public static final Block TENT_POLE = add("tent_pole", new TentPoleBlock(FabricBlockSettings.of(Material.WOOD).nonOpaque().strength(0.8f).sounds(BlockSoundGroup.WOOD)), (ItemGroup) null);
	...
	private static TentSideBlock tentSide(DyeColor color) {
		return add(color.getName() + "_tent_side", new TentSideBlock(FabricBlockSettings.of(Material.WOOL).nonOpaque().strength(0.8f).sounds(BlockSoundGroup.WOOL), color), (ItemGroup) null);
	}

	private static TentTopBlock tentTop(DyeColor color) {
		return add(color.getName() + "_tent_top", new TentTopBlock(FabricBlockSettings.of(Material.WOOL).nonOpaque().strength(0.8f).sounds(BlockSoundGroup.WOOL), color), (ItemGroup) null);
	}

	private static TentTopPoleBlock toppedTentPole(DyeColor color) {
		return add(color.getName() + "_topped_tent_pole", new TentTopPoleBlock(FabricBlockSettings.of(Material.WOOL).nonOpaque().strength(0.8f).sounds(BlockSoundGroup.WOOL), color), (ItemGroup) null);
	}

	private static TentTopFlatBlock tentTopFlat(DyeColor color) {
		return add(color.getName() + "_flat_tent_top", new TentTopFlatBlock(FabricBlockSettings.of(Material.WOOL).nonOpaque().strength(0.8f).sounds(BlockSoundGroup.WOOL), color), (ItemGroup) null);
	}
